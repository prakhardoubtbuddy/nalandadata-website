...
function MiniIcon({ org }) {
  ...
  if (org === "Anthropic") return (
    <div className="s-mini-icon" style={{ background: "#CC785C" }}>
      <svg viewBox="0 0 24 24" width="14" height="14" fill="white"><path d="M12 2L13.8 10.2L22 12L13.8 13.8L12 22L10.2 13.8L2 12L10.2 10.2Z"/></svg>
    </div>
  );
  ...
  if (org === "Meta") return (
    <div className="s-mini-icon" style={{ background: "#0082FB" }}>
      <svg viewBox="0 0 24 24" width="10" height="10" fill="white"><path d="M12 2.04c-5.5 0-10 4.49-10 10.02 0 5 3.66 9.15 8.44 9.9v-7H7.9v-2.9h2.54V9.85c0-2.51 1.49-3.89 3.78-3.89 1.09 0 2.23.19 2.23.19v2.47h-1.26c-1.24 0-1.63.77-1.63 1.56v1.88h2.78l-.45 2.9h-2.33v7a10 10 0 0 0 8.44-9.9c0-5.53-4.5-10.02-10-10.02z"/></svg>
    </div>
  );
  return <div className="s-mini-icon" style={{ background: "#666" }} />;
}
